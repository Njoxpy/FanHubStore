    ...
    <main>
      <div className="p-8 bg-blue text-white">
        <div>
          ...
          <a href="https://www.instagram.com/dont_blame_njox/" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
          ...
          <a href="https://twitter.com/Njox16" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
