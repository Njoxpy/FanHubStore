  ...
  return (
    <main>
      <div className="p-8 bg-blue text-white">
        <h1 className="font-bold p-2">Stay Connected With Us</h1>
        <div className="flex justify-start p-2">
          ...
          <a
            href="https://www.instagram.com/dont_blame_njox/"
            target="_blank"
        ...
        <div className="flex justify-end flex-col">
          ...
          <p>
            Email Us:
            <a href="mailto:fanhubstore@gmail.com" className="">
...
- Style the svg files using tailwind.
*/
